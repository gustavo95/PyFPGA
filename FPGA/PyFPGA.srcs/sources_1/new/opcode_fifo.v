    ...
    always @(posedge CLK or posedge RESET) begin
        if (RESET) begin
            ...
            if (fifo_save && !fifo_full) begin
                ...
                fifo_arg_type[write_ptr] <= arg_type_in;
                fifo_arg_value[write_ptr] <= arg_value_in;
                ...
                arg_type_out <= fifo_arg_type[read_ptr];
                arg_value_out <= fifo_arg_value[read_ptr];
